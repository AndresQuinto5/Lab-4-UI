...
textures = {
    '1' : pygame.image.load('./utils/wall1.png'),
    '2' : pygame.image.load('./utils/wall2.png'),
    '3' : pygame.image.load('./utils/wall3.png'),
    '4' : pygame.image.load('./utils/wall4.png'),
    '5' : pygame.image.load('./utils/wall5.png')
    }
...
def main_menu():
    ...
    click = False
    btn_ctr = 0
    Backg = pygame.image.load("./utils/Nazi.jpg")
